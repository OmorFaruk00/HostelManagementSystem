  ...
  <div>
    <div class="sticky-top">
      <nav class="navbar navbar-expand-lg topnav d-flex justify-content-between">
        <div class="d-flex">
          <span class="menu" id="menu-toggle"><i @click="auth.menu" class="fa fa-bars"></i>
          </span>
          <h4 class="cms-title">Hostel Management System</h4>
        </div>
        <div class="">
          <div class="dropdown">
            <img src="/images/user3.png" alt="user" class="user-icon" @click="auth.userprofile()">
            <div id="user" class="dropdown-content pt-4">
              ...
              <div class="user-text">
                <h4 class="text-center mt-3">{{ auth.user }}</h4>
                <p></p>
              </div>
              <hr>
              ...
              <div class="btn-hover">
                <span class="profile-btn" @click="auth.logout"><img src="/images/logout.png" alt="" class="">Log out</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="d-flex " id="wrapper">
      <div id="sidebar-wrapper" class="">
        <div class="list-group sidebar">
          ...
          <div v-if="auth.account" class="dropdown_item">
...
#page-content-wrapper {
  flex: 1;
  /* Allow the content container to fill the remaining width */
  /* margin-left: 250px; */
  display: block;
